...
const itemDefinitions: Record<number, ItemDisplayDefinition> = {
  ...
  3122: { name: "Badge Bolt Pistol", description: "Compact Badge Bolt sidearm.", category: "gear" },
  3123: { name: "Slagrail Vanguard", description: "Rifle built around the Slagrail Vanguard pattern.", category: "gear" },
  3124: { name: "Coilgate Scatter", description: "Close-range Coilgate scatter weapon.", category: "gear" },
  3125: { name: "Kiln Long Pattern", description: "Long-pattern Kiln precision rifle.", category: "gear" },
  3126: { name: "Bastion LMG", description: "Bastion-pattern light machine gun.", category: "gear" },
  3127: { name: "Flare Net Launcher", description: "Flare Net launcher for area denial.", category: "gear" },
