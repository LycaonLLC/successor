...
test("builds a separately versioned beta pointer", () => {
  assert.deepEqual(
    buildPromotion(good, commit, "successor-rust-beta@a2d02071e180f9df", {
      channel: "beta",
      serverReleaseId: "server-r1",
    }),
    {
      schema: "successor.client-runtime-pointer.v1",
      entry: good.launchPage,
      manifestSha256: hash,
      sourceCommit: commit,
      clientReleaseId: "successor-rust-beta@a2d02071e180f9df",
      serverReleaseId: "server-r1",
      channel: "beta",
    },
  );
