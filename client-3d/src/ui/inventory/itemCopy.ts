...
export const ITEM_DESCRIPTION_BY_ID: Record<number, string> = {
  ...
  3104: "Plasma-edged sword with powered hilt",
  3105: "Reclaimed-steel field blade",
  3106: "Militia saber balanced for reach",
  3107: "Forward-weighted quarry work blade",
  3111: "Compact STEN-pattern submachine gun",
  3112: "Energy carbine built on the STEN frame",
  3121: "Storm-pattern carbine with electric discharge",
  3122: "Compact Badge Bolt sidearm",
  3123: "Slagrail-pattern assault rifle",
  3124: "Coilgate close-range scatter weapon",
  3125: "Long-pattern Kiln precision rifle",
  3126: "Bastion light machine gun",
  3127: "Flare Net area-denial launcher",
